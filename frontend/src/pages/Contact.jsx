  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row justify-center items-center gap-12 mb-28 px-4 md:px-16 h-full ' >
        ...
        {/* Contact Details */}
        <div className='flex-1 flex flex-col gap-8 text-gray-700  justify-center  border-2 border-orange-950 h-full p-4 lg:p-8 rounded-lg shadow-md'>
          {/* Store Details */}
          <div>
            <p className='font-semibold text-2xl text-gray-800 mb-2 teko tracking-wider'>Our Location</p>
            ...
            <p className='text-gray-500 mt-2'>
              Tel: +91 82956-99366 <br />
              Email: <a href="mailto:hello@gmail.com" className='text-orange-950 font-medium hover:underline'>
