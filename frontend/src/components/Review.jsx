    ...
    return (
        <div className="mt-20">
            {!token ? (
                ...
                <>
                    <Title text1="Reviews" text2={`(${reviews.length})`} />

                    <div className='w-full gap-0 sm:flex sm:flex-row lg:grid lg:grid-cols-3 items-center border justify-center'>
                        {reviews.length > 0 && (
                            <div className="flex items-center gap-2 justify-center border w-full h-full p-4">
                                ...
                                <span>({calculateAverageRating().toFixed(1)})</span>
                            </div>
                        )}
